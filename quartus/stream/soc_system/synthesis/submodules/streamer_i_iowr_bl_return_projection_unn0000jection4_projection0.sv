...
// SystemVerilog created from i_iowr_bl_return_projection_unnamed_projection4_projection0
...
module streamer_i_iowr_bl_return_projection_unn0000jection4_projection0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_projection_i_fifoready;
    ...
    assign out_iowr_bl_return_projection_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_return_projection_o_fifodata = iowr_o_fifodata;
