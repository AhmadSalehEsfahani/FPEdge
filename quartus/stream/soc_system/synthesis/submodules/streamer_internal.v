...
(
   ...
   input logic resetn,
   // AVS avs_tuple_in
   input logic avs_tuple_in_enable,
   input logic avs_tuple_in_read,
   input logic avs_tuple_in_write,
   input logic avs_tuple_in_address,
   input logic [511:0] avs_tuple_in_writedata,
   input logic [63:0] avs_tuple_in_byteenable,
   output logic [511:0] avs_tuple_in_readdata,
   output logic avs_tuple_in_readdatavalid,
   // AVS avs_tuple_out
   input logic avs_tuple_out_enable,
   input logic avs_tuple_out_read,
   input logic avs_tuple_out_write,
   input logic avs_tuple_out_address,
   input logic [511:0] avs_tuple_out_writedata,
   input logic [63:0] avs_tuple_out_byteenable,
   output logic [511:0] avs_tuple_out_readdata,
   output logic avs_tuple_out_readdatavalid
);
   genvar __i;
   genvar __j;
   genvar __k;
   ...
   logic [511:0] local_avm_aspace64_writedata [1][3];
   logic [63:0] local_avm_aspace64_byteenable [1][3];
   logic local_avm_aspace64_waitrequest [1][3];
   logic [511:0] local_avm_aspace64_readdata [1][3];
   ...
   logic [511:0] local_avm_aspace65_writedata [1][3];
   logic [63:0] local_avm_aspace65_byteenable [1][3];
   logic local_avm_aspace65_waitrequest [1][3];
   logic [511:0] local_avm_aspace65_readdata [1][3];
   ...
   (
      .clock(clock),
      .resetn(resetn),
      // AVM avm_memcoalesce_load_streamer_fpgaunique_53_streamer
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_enable(local_avm_aspace64_enable[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_read(local_avm_aspace64_read[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_write(local_avm_aspace64_write[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_address(local_avm_aspace64_address[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_writedata(local_avm_aspace64_writedata[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_byteenable(local_avm_aspace64_byteenable[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_waitrequest(local_avm_aspace64_waitrequest[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_readdata(local_avm_aspace64_readdata[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_readdatavalid(local_avm_aspace64_readdatavalid[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_burstcount(local_avm_aspace64_burstcount[0][0]),
      .avm_memcoalesce_load_streamer_fpgaunique_53_streamer_writeack(local_avm_aspace64_writeack[0][0]),
      // AVM avm_tuple_in_load
      .avm_tuple_in_load_enable(local_avm_aspace64_enable[0][1]),
      .avm_tuple_in_load_read(local_avm_aspace64_read[0][1]),
      .avm_tuple_in_load_write(local_avm_aspace64_write[0][1]),
      .avm_tuple_in_load_address(local_avm_aspace64_address[0][1]),
      .avm_tuple_in_load_writedata(local_avm_aspace64_writedata[0][1]),
      .avm_tuple_in_load_byteenable(local_avm_aspace64_byteenable[0][1]),
      .avm_tuple_in_load_waitrequest(local_avm_aspace64_waitrequest[0][1]),
      .avm_tuple_in_load_readdata(local_avm_aspace64_readdata[0][1]),
      .avm_tuple_in_load_readdatavalid(local_avm_aspace64_readdatavalid[0][1]),
      .avm_tuple_in_load_burstcount(local_avm_aspace64_burstcount[0][1]),
      .avm_tuple_in_load_writeack(local_avm_aspace64_writeack[0][1]),
      // AVM avm_tuple_in_store
      .avm_tuple_in_store_enable(local_avm_aspace64_enable[0][2]),
      .avm_tuple_in_store_read(local_avm_aspace64_read[0][2]),
      .avm_tuple_in_store_write(local_avm_aspace64_write[0][2]),
      .avm_tuple_in_store_address(local_avm_aspace64_address[0][2]),
      .avm_tuple_in_store_writedata(local_avm_aspace64_writedata[0][2]),
      .avm_tuple_in_store_byteenable(local_avm_aspace64_byteenable[0][2]),
      .avm_tuple_in_store_waitrequest(local_avm_aspace64_waitrequest[0][2]),
      .avm_tuple_in_store_readdata(local_avm_aspace64_readdata[0][2]),
      .avm_tuple_in_store_readdatavalid(local_avm_aspace64_readdatavalid[0][2]),
      .avm_tuple_in_store_burstcount(local_avm_aspace64_burstcount[0][2]),
      .avm_tuple_in_store_writeack(local_avm_aspace64_writeack[0][2]),
      // AVM avm_memdep_14_streamer
      .avm_memdep_14_streamer_enable(local_avm_aspace65_enable[0][0]),
      .avm_memdep_14_streamer_read(local_avm_aspace65_read[0][0]),
      .avm_memdep_14_streamer_write(local_avm_aspace65_write[0][0]),
      .avm_memdep_14_streamer_address(local_avm_aspace65_address[0][0]),
      .avm_memdep_14_streamer_writedata(local_avm_aspace65_writedata[0][0]),
      .avm_memdep_14_streamer_byteenable(local_avm_aspace65_byteenable[0][0]),
      .avm_memdep_14_streamer_waitrequest(local_avm_aspace65_waitrequest[0][0]),
      .avm_memdep_14_streamer_readdata(local_avm_aspace65_readdata[0][0]),
      .avm_memdep_14_streamer_readdatavalid(local_avm_aspace65_readdatavalid[0][0]),
      .avm_memdep_14_streamer_burstcount(local_avm_aspace65_burstcount[0][0]),
      .avm_memdep_14_streamer_writeack(local_avm_aspace65_writeack[0][0]),
      // AVM avm_tuple_out_load
      .avm_tuple_out_load_enable(local_avm_aspace65_enable[0][1]),
      .avm_tuple_out_load_read(local_avm_aspace65_read[0][1]),
      .avm_tuple_out_load_write(local_avm_aspace65_write[0][1]),
      .avm_tuple_out_load_address(local_avm_aspace65_address[0][1]),
      .avm_tuple_out_load_writedata(local_avm_aspace65_writedata[0][1]),
      .avm_tuple_out_load_byteenable(local_avm_aspace65_byteenable[0][1]),
      .avm_tuple_out_load_waitrequest(local_avm_aspace65_waitrequest[0][1]),
      .avm_tuple_out_load_readdata(local_avm_aspace65_readdata[0][1]),
      .avm_tuple_out_load_readdatavalid(local_avm_aspace65_readdatavalid[0][1]),
      .avm_tuple_out_load_burstcount(local_avm_aspace65_burstcount[0][1]),
      .avm_tuple_out_load_writeack(local_avm_aspace65_writeack[0][1]),
      // AVM avm_tuple_out_store
      .avm_tuple_out_store_enable(local_avm_aspace65_enable[0][2]),
      .avm_tuple_out_store_read(local_avm_aspace65_read[0][2]),
      .avm_tuple_out_store_write(local_avm_aspace65_write[0][2]),
      .avm_tuple_out_store_address(local_avm_aspace65_address[0][2]),
      .avm_tuple_out_store_writedata(local_avm_aspace65_writedata[0][2]),
      .avm_tuple_out_store_byteenable(local_avm_aspace65_byteenable[0][2]),
      .avm_tuple_out_store_waitrequest(local_avm_aspace65_waitrequest[0][2]),
      .avm_tuple_out_store_readdata(local_avm_aspace65_readdata[0][2]),
      .avm_tuple_out_store_readdatavalid(local_avm_aspace65_readdatavalid[0][2]),
      .avm_tuple_out_store_burstcount(local_avm_aspace65_burstcount[0][2]),
      .avm_tuple_out_store_writeack(local_avm_aspace65_writeack[0][2]),
      // AVS avs_tuple_in
      .avs_tuple_in_enable(avs_tuple_in_enable),
      .avs_tuple_in_read(avs_tuple_in_read),
      .avs_tuple_in_write(avs_tuple_in_write),
      .avs_tuple_in_address(avs_tuple_in_address),
      .avs_tuple_in_writedata(avs_tuple_in_writedata),
      .avs_tuple_in_byteenable(avs_tuple_in_byteenable),
      .avs_tuple_in_readdata(avs_tuple_in_readdata),
      .avs_tuple_in_readdatavalid(avs_tuple_in_readdatavalid),
      // AVS avs_tuple_out
      .avs_tuple_out_enable(avs_tuple_out_enable),
      .avs_tuple_out_read(avs_tuple_out_read),
      .avs_tuple_out_write(avs_tuple_out_write),
      .avs_tuple_out_address(avs_tuple_out_address),
      .avs_tuple_out_writedata(avs_tuple_out_writedata),
      .avs_tuple_out_byteenable(avs_tuple_out_byteenable),
      .avs_tuple_out_readdata(avs_tuple_out_readdata),
      .avs_tuple_out_readdatavalid(avs_tuple_out_readdatavalid)
   );
   ...
   begin:local_mem_system_aspace64
      ...
      logic [511:0] local_icm_arb_writedata [1][3];
      logic [63:0] local_icm_arb_byteenable [1][3];
      logic local_icm_arb_stall [1][3];
      logic local_icm_wrp_ack [1][3];
      logic local_icm_rrp_datavalid [1][3];
      logic [511:0] local_icm_rrp_data [1][3];
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            // INST data_ic of streamer_internal_ic_17750171287261491324
            streamer_internal_ic_17750171287261491324 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
         ...
         begin:port2bank0
            ...
            // INST data_ic of streamer_internal_ic_3613680218077241098
            streamer_internal_ic_3613680218077241098 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
   ...
   begin:local_mem_system_aspace65
      ...
      begin:local_mem_group
         ...
         begin:port1bank0
            ...
            // INST data_ic of streamer_internal_ic_7495972156186162414
            streamer_internal_ic_7495972156186162414 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
         ...
         begin:port2bank0
            ...
            // INST data_ic of streamer_internal_ic_9171148185651901892
            streamer_internal_ic_9171148185651901892 data_ic
            (
               .clock(clock),
               .resetn(resetn),
               // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE streamer_internal_ic_17750171287261491324
/////////////////////////////////////////////////////////////////
module streamer_internal_ic_17750171287261491324
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE streamer_internal_ic_3613680218077241098
/////////////////////////////////////////////////////////////////
module streamer_internal_ic_3613680218077241098
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE streamer_internal_ic_7495972156186162414
/////////////////////////////////////////////////////////////////
module streamer_internal_ic_7495972156186162414
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE streamer_internal_ic_9171148185651901892
/////////////////////////////////////////////////////////////////
module streamer_internal_ic_9171148185651901892
(
   input logic clock,
