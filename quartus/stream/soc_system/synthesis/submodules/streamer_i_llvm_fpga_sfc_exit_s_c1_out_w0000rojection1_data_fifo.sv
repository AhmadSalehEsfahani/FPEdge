...
// SystemVerilog created from i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection1_data_fifo
...
module streamer_i_llvm_fpga_sfc_exit_s_c1_out_w0000rojection1_data_fifo (
    ...
    wire [415:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall;
    wire i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid;
    wire i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full;
    wire i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full_bitsignaltemp;
    wire [415:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_data;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall;
    wire i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall_bitsignaltemp;
    wire [0:0] i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid;
    wire i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid_bitsignaltemp;
    ...
    assign ip_dsdk_adapt_bitselect41_b = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_data[415:32];
    ...
    assign ip_dsdk_adapt_bitselect39_b = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_data[0:0];
    ...
    // i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0(EXTIFACE,37)
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_data = dsdk_ip_adapt_bitjoin1_q;
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall = in_i_stall;
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid = in_i_valid;
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall[0];
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid_bitsignaltemp = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid[0];
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full[0] = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall[0] = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall_bitsignaltemp;
    assign i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid[0] = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid_bitsignaltemp;
    hld_fifo #(
        .DEPTH(32),
        .STYLE("ms"),
        .ASYNC_RESET(1),
        ...
        .SYNCHRONIZE_RESET(0),
        .WIDTH(416)
    ) thei_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0 (
        .i_data(dsdk_ip_adapt_bitjoin1_q),
        .i_stall(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_stall_bitsignaltemp),
        .i_valid(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_i_valid_bitsignaltemp),
        .o_almost_full(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full_bitsignaltemp),
        .o_data(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_data),
        .o_stall(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall_bitsignaltemp),
        .o_valid(i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid_bitsignaltemp),
        .clock(clock),
        .resetn(resetn)
    );

    // dupName_0_sync_out_aunroll_x(GPOUT,2)@20000000
    assign out_o_almost_full = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_almost_full;
    ...
    assign out_o_valid = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_valid;

    // sync_out(GPOUT,74)@20000000
    assign out_o_stall = i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_projections_c1_exit_projection0_o_stall;
