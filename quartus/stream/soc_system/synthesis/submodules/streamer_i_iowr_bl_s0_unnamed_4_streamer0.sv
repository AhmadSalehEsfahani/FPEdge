...
// SystemVerilog created from i_iowr_bl_s0_unnamed_streamer4_streamer0
...
module streamer_i_iowr_bl_s0_unnamed_4_streamer0 (
    ...
    wire [39:0] dsdk_ip_array_adapt_bitjoin15_q;
    wire [159:0] dsdk_ip_array_adapt_bitjoin19_q;
    ...
    // dsdk_ip_array_adapt_bitjoin19(BITJOIN,34)
    assign dsdk_ip_array_adapt_bitjoin19_q = {in_i_data_14_tpl, in_i_data_13_tpl, in_i_data_12_tpl, in_i_data_11_tpl, in_i_data_10_tpl};

    // dsdk_ip_array_adapt_bitjoin15(BITJOIN,33)
    assign dsdk_ip_array_adapt_bitjoin15_q = {in_i_data_9_tpl, in_i_data_8_tpl, in_i_data_7_tpl, in_i_data_6_tpl, in_i_data_5_tpl};

    // dsdk_ip_array_adapt_bitjoin4(BITJOIN,35)
    assign dsdk_ip_array_adapt_bitjoin4_q = {in_i_data_4_tpl, in_i_data_3_tpl, in_i_data_2_tpl, in_i_data_1_tpl};

    // c_i24_018(CONSTANT,29)
    assign c_i24_018_q = $unsigned(24'b000000000000000000000000);

    // dsdk_ip_adapt_bitjoin1(BITJOIN,32)
    assign dsdk_ip_adapt_bitjoin1_q = {dsdk_ip_array_adapt_bitjoin19_q, c_i24_018_q, dsdk_ip_array_adapt_bitjoin15_q, dsdk_ip_array_adapt_bitjoin4_q, c_i24_018_q, in_i_data_0_tpl};
    ...
    assign out_iowr_bl_s0_o_fifovalid = iowr_o_fifovalid;
