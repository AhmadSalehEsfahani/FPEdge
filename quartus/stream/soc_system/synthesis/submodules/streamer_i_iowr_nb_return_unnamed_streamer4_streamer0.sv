...
// SystemVerilog created from i_iowr_nb_return_streamer_unnamed_streamer4_streamer0
...
module streamer_i_iowr_nb_return_unnamed_streamer4_streamer0 (
    ...
    // element_extension1(BITJOIN,9)@7
    assign element_extension1_q = {c_i7_02_q, in_i_data};

    // iowr_nb(EXTIFACE,11)@7
