...
// SystemVerilog created from i_iowr_nb_return_streamer_unnamed_streamer7_streamer0
...
module streamer_i_iowr_nb_return_unnamed_streamer7_streamer0 (
    output wire [0:0] out_iowr_nb_return_streamer_o_fifovalid,
    output wire [0:0] out_o_ack,
    output wire [0:0] out_o_valid,
    output wire [31:0] out_iowr_nb_return_streamer_o_fifodata,
