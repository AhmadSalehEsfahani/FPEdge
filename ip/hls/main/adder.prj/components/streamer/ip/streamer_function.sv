...
module streamer_function (
    ...
    wire [31:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address;
    wire [0:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount;
    wire [7:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable;
    wire [0:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable;
    wire [0:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read;
    wire [0:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write;
    wire [63:0] bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata;
    ...
    wire [15:0] bb_streamer_B1_start_out_memdep_14_streamer_avm_byteenable;
    ...
    wire [127:0] bb_streamer_B1_start_out_memdep_14_streamer_avm_writedata;
    ...
    streamer_bb_B1_start thebb_streamer_B1_start (
        ...
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write),
        .out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata(bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata),
    ...
    // out_iowr_nb_return_streamer_o_fifodata(GPOUT,32)
    assign out_iowr_nb_return_streamer_o_fifodata = bb_streamer_B1_start_out_iowr_nb_return_streamer_o_fifodata;

    // out_iowr_nb_return_streamer_o_fifovalid(GPOUT,33)
    assign out_iowr_nb_return_streamer_o_fifovalid = bb_streamer_B1_start_out_iowr_nb_return_streamer_o_fifovalid;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address(GPOUT,34)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_address;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount(GPOUT,35)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_burstcount;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable(GPOUT,36)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_byteenable;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable(GPOUT,37)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_enable;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read(GPOUT,38)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_read;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write(GPOUT,39)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_write;

    // out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata(GPOUT,40)
    assign out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata = bb_streamer_B1_start_out_memcoalesce_load_streamer_fpgaunique_33_streamer_avm_writedata;

    // out_memdep_14_streamer_avm_address(GPOUT,41)
    assign out_memdep_14_streamer_avm_address = bb_streamer_B1_start_out_memdep_14_streamer_avm_address;

    // out_memdep_14_streamer_avm_burstcount(GPOUT,42)
    assign out_memdep_14_streamer_avm_burstcount = bb_streamer_B1_start_out_memdep_14_streamer_avm_burstcount;

    // out_memdep_14_streamer_avm_byteenable(GPOUT,43)
    assign out_memdep_14_streamer_avm_byteenable = bb_streamer_B1_start_out_memdep_14_streamer_avm_byteenable;

    // out_memdep_14_streamer_avm_enable(GPOUT,44)
    assign out_memdep_14_streamer_avm_enable = bb_streamer_B1_start_out_memdep_14_streamer_avm_enable;

    // out_memdep_14_streamer_avm_read(GPOUT,45)
    assign out_memdep_14_streamer_avm_read = bb_streamer_B1_start_out_memdep_14_streamer_avm_read;

    // out_memdep_14_streamer_avm_write(GPOUT,46)
    assign out_memdep_14_streamer_avm_write = bb_streamer_B1_start_out_memdep_14_streamer_avm_write;

    // out_memdep_14_streamer_avm_writedata(GPOUT,47)
    ...
    // streamer_B1_start_x(EXTIFACE,50)
