...
module windowing_bb_aggregation_B0_runOnce (
    ...
    windowing_aggregation_B0_runOnce_branch theaggregation_B0_runOnce_branch (
    ...
    windowing_bb_aggregation_B0_runOnce_stall_region thebb_aggregation_B0_runOnce_stall_region (
    ...
    windowing_aggregation_B0_runOnce_merge theaggregation_B0_runOnce_merge (
