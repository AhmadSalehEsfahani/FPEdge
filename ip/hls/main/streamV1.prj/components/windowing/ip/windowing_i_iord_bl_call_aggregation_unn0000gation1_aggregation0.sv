...
// SystemVerilog created from i_iord_bl_call_aggregation_unnamed_aggregation1_aggregation0
...
module windowing_i_iord_bl_call_aggregation_unn0000gation1_aggregation0 (
    ...
    wire [159:0] ip_dsdk_adapt_bitselect18_b;
    wire [351:0] ip_dsdk_adapt_bitselect2_b;
    ...
    // iord(EXTIFACE,8)
    assign iord_i_fifodata = in_iord_bl_call_aggregation_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_aggregation_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_aggregation_i_fifodata),
    ...
    // ip_dsdk_adapt_bitselect34(BITSELECT,22)
    assign ip_dsdk_adapt_bitselect34_b = iord_o_data[416:416];
    ...
    // ip_dsdk_adapt_bitselect32(BITSELECT,21)
    assign ip_dsdk_adapt_bitselect32_b = iord_o_data[415:384];

    // ip_dsdk_adapt_bitselect30(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect30_b = iord_o_data[383:352];

    // ip_dsdk_adapt_bitselect2(BITSELECT,14)
    assign ip_dsdk_adapt_bitselect2_b = iord_o_data[351:0];

    // ip_dsdk_adapt_bitselect18(BITSELECT,13)
    assign ip_dsdk_adapt_bitselect18_b = ip_dsdk_adapt_bitselect2_b[351:192];

    // ip_dsdk_adapt_bitselect28(BITSELECT,19)
    assign ip_dsdk_adapt_bitselect28_b = ip_dsdk_adapt_bitselect18_b[159:128];

    // ip_dsdk_adapt_bitselect26(BITSELECT,18)
    assign ip_dsdk_adapt_bitselect26_b = ip_dsdk_adapt_bitselect18_b[127:96];

    // ip_dsdk_adapt_bitselect24(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect24_b = ip_dsdk_adapt_bitselect18_b[95:64];

    // ip_dsdk_adapt_bitselect22(BITSELECT,16)
    assign ip_dsdk_adapt_bitselect22_b = ip_dsdk_adapt_bitselect18_b[63:32];

    // ip_dsdk_adapt_bitselect20(BITSELECT,15)
    assign ip_dsdk_adapt_bitselect20_b = ip_dsdk_adapt_bitselect18_b[31:0];

    // ip_dsdk_adapt_bitselect16(BITSELECT,12)
    assign ip_dsdk_adapt_bitselect16_b = ip_dsdk_adapt_bitselect2_b[167:160];
    ...
    assign out_o_data_13_tpl = adapt_scalar_trunc35_q;
    assign out_o_valid = iord_o_valid;

    // dupName_0_regfree_osync_x(GPOUT,3)
    assign out_iord_bl_call_aggregation_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,41)
    assign out_iord_bl_call_aggregation_o_fifoalmost_full = iord_o_fifoalmost_full;
