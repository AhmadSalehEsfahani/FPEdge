...
// SystemVerilog created from i_iowr_bl_return_aggregation_unnamed_aggregation2_aggregation0
...
module windowing_i_iowr_bl_return_aggregation_u0000gation2_aggregation0 (
    ...
    wire [23:0] c_i24_03_q;
    wire [351:0] dsdk_ip_adapt_bitjoin1_q;
    wire [127:0] dsdk_ip_array_adapt_bitjoin4_q;
    wire [159:0] dsdk_ip_array_adapt_bitjoin8_q;
    wire [351:0] iowr_i_data;
    ...
    // dsdk_ip_array_adapt_bitjoin8(BITJOIN,25)
    assign dsdk_ip_array_adapt_bitjoin8_q = {in_i_data_10_tpl, in_i_data_9_tpl, in_i_data_8_tpl, in_i_data_7_tpl, in_i_data_6_tpl};

    // dsdk_ip_array_adapt_bitjoin4(BITJOIN,24)
    assign dsdk_ip_array_adapt_bitjoin4_q = {in_i_data_4_tpl, in_i_data_3_tpl, in_i_data_2_tpl, in_i_data_1_tpl};

    // c_i24_03(CONSTANT,20)
    assign c_i24_03_q = $unsigned(24'b000000000000000000000000);

    // dsdk_ip_adapt_bitjoin1(BITJOIN,23)
    assign dsdk_ip_adapt_bitjoin1_q = {dsdk_ip_array_adapt_bitjoin8_q, c_i24_03_q, in_i_data_5_tpl, dsdk_ip_array_adapt_bitjoin4_q, c_i24_03_q, in_i_data_0_tpl};

    // iowr(EXTIFACE,26)
    assign iowr_i_data = dsdk_ip_adapt_bitjoin1_q;
    assign iowr_i_endofpacket = GND_q;
    assign iowr_i_fifoready = in_iowr_bl_return_aggregation_i_fifoready;
    ...
    assign out_iowr_bl_return_aggregation_o_fifovalid = iowr_o_fifovalid;

    // dupName_0_sync_out_x(GPOUT,4)@78
    assign out_o_ack = iowr_o_ack;
    assign out_o_valid = iowr_o_valid;

    // regfree_osync(GPOUT,28)
    assign out_iowr_bl_return_aggregation_o_fifodata = iowr_o_fifodata;
