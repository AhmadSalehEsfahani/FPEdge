...
// SystemVerilog created from flt_i_sfc_logic_s_c1_in_wt_entry_aggregations_c1_enter_aggregation0_castBlock_typeSFixed_32_0_typeSFloatIEEE_23_8_castModeConvert_3v4i0g8veqmewngwzg9ei063065063663c65c62i65i62o62u63760d60j61v652c4e61k63ki03633653c3l60uq5ux5gv8yll5gvbyxk5id06uq0cp0ju20cp0jo0ouz
...
module windowing_flt_i_sfc_logic_s_c1_in_wt_ent00006uq0cp0ju20cp0jo0ouz (
    ...
    reg [23:0] redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_q;
    reg [23:0] redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_0;
    reg [23:0] redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_1;
    ...
    reg [22:0] redist14_fracR_uid25_block_rsrvd_fix_b_2_q;
    reg [22:0] redist14_fracR_uid25_block_rsrvd_fix_b_2_delay_0;
    reg [0:0] redist15_sticky_uid20_block_rsrvd_fix_q_2_q;
    reg [32:0] redist16_expFracRnd_uid16_block_rsrvd_fix_q_1_q;
    ...
    begin
        ...
        begin
            ...
            redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_1 <= '0;
            redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_q <= '0;
        end
        else
        begin
            redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_0 <= $unsigned(fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b);
            redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_1 <= redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_0;
            redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_q <= redist0_fracRnd_uid15_block_rsrvd_fix_merged_bit_select_b_3_delay_1;
        end
    end
    ...
    assign expFracR_uid24_block_rsrvd_fix_a = $unsigned({{2{redist16_expFracRnd_uid16_block_rsrvd_fix_q_1_q[32]}}, redist16_expFracRnd_uid16_block_rsrvd_fix_q_1_q});
