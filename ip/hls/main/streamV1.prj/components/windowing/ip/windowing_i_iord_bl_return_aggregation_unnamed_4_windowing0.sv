...
// SystemVerilog created from i_iord_bl_return_aggregation_unnamed_windowing4_windowing0
...
module windowing_i_iord_bl_return_aggregation_unnamed_4_windowing0 (
    ...
    // iord(EXTIFACE,6)
    assign iord_i_fifodata = in_iord_bl_return_aggregation_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_return_aggregation_i_fifovalid;
    assign iord_i_predicate = in_c0_exe4140;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_return_aggregation_i_fifodata),
    ...
    assign out_iord_bl_return_aggregation_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,33)
    assign out_iord_bl_return_aggregation_o_fifoalmost_full = iord_o_fifoalmost_full;
