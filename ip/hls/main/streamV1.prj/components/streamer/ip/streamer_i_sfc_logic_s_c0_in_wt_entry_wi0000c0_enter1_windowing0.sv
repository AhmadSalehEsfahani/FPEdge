...
module streamer_i_sfc_logic_s_c0_in_wt_entry_wi0000c0_enter1_windowing0 (
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_windowing2_out_exiting_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_windowing2_out_exiting_valid_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_windowing2_out_not_exitcond_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going_windowing2_out_pipeline_valid_out;
    ...
    streamer_i_llvm_fpga_pipeline_keep_going_windowing0 thei_llvm_fpga_pipeline_keep_going_windowing2 (
        .in_data_in(VCC_q),
        .in_initeration_in(GND_q),
        .in_initeration_valid_in(GND_q),
        .in_not_exitcond_in(i_llvm_fpga_push_i1_notexitcond_windowing3_out_feedback_out_2),
        ...
        .out_not_exitcond_stall_out(i_llvm_fpga_pipeline_keep_going_windowing2_out_not_exitcond_stall_out),
        .out_pipeline_valid_out(i_llvm_fpga_pipeline_keep_going_windowing2_out_pipeline_valid_out),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_windowing2_exiting_valid_out = i_llvm_fpga_pipeline_keep_going_windowing2_out_exiting_valid_out;
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going_windowing2_exiting_stall_out = i_llvm_fpga_pipeline_keep_going_windowing2_out_exiting_stall_out;

    // pipeline_valid_out_sync(GPOUT,15)
    assign out_pipeline_valid_out = i_llvm_fpga_pipeline_keep_going_windowing2_out_pipeline_valid_out;
