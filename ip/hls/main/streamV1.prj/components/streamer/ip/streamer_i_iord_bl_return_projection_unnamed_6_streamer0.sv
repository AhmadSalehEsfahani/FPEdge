...
// SystemVerilog created from i_iord_bl_return_projection_unnamed_streamer6_streamer0
...
module streamer_i_iord_bl_return_projection_unnamed_6_streamer0 (
    ...
    // iord(EXTIFACE,8)
    assign iord_i_fifodata = in_iord_bl_return_projection_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_return_projection_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_return_projection_i_fifodata),
    ...
    assign out_iord_bl_return_projection_o_fifoready = iord_o_fifoready;
    ...
    assign out_iord_bl_return_projection_o_fifoalmost_full = iord_o_fifoalmost_full;
