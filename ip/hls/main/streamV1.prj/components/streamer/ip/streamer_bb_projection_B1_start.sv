...
module streamer_bb_projection_B1_start (
    ...
    wire [0:0] bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoalmost_full;
    wire [0:0] bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoready;
    ...
    wire [383:0] bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifodata;
    wire [0:0] bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifovalid;
    ...
    streamer_bb_projection_B1_start_stall_region thebb_projection_B1_start_stall_region (
        ...
        .out_iord_bl_s0_o_fifoalmost_full(bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoalmost_full),
        .out_iord_bl_s0_o_fifoready(bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoready),
        ...
        .out_iowr_bl_s1_o_fifodata(bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifodata),
        .out_iowr_bl_s1_o_fifovalid(bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifovalid),
    ...
    assign out_iord_bl_s0_o_fifoalmost_full = bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,17)
    assign out_iord_bl_s0_o_fifoready = bb_projection_B1_start_stall_region_out_iord_bl_s0_o_fifoready;
    ...
    // out_iowr_bl_s1_o_fifodata(GPOUT,20)
    assign out_iowr_bl_s1_o_fifodata = bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifodata;

    // out_iowr_bl_s1_o_fifovalid(GPOUT,21)
    assign out_iowr_bl_s1_o_fifovalid = bb_projection_B1_start_stall_region_out_iowr_bl_s1_o_fifovalid;
