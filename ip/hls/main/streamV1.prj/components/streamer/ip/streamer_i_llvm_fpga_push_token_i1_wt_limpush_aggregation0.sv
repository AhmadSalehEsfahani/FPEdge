...
module streamer_i_llvm_fpga_push_token_i1_wt_limpush_aggregation0 (
    ...
    streamer_i_llvm_fpga_push_token_i1_wt_limpush_aggregation1_reg thei_llvm_fpga_push_token_i1_wt_limpush_aggregation1_reg (
