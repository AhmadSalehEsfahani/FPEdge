...
// SystemVerilog created from i_iowr_bl_call_windowing_unnamed_streamer4_streamer0
...
module streamer_i_iowr_bl_call_windowing_unnamed_4_streamer0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_call_windowing_i_fifoready;
    ...
    assign out_iowr_bl_call_windowing_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_call_windowing_o_fifodata = iowr_o_fifodata;
