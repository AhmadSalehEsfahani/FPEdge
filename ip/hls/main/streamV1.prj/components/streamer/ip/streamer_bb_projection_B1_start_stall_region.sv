...
module streamer_bb_projection_B1_start_stall_region (
    ...
    // out out_valid_out@1
    streamer_projection_B1_start_merge_reg theprojection_B1_start_merge_reg (
        .in_data_in(GND_q),
    ...
    streamer_i_sfc_s_c0_in_wt_entry_projecti00000_enter1_projection0 thei_sfc_s_c0_in_wt_entry_projections_c0_enter1_projection0_aunroll_x (
    ...
    // out out_o_stall@20000000
    streamer_i_iord_bl_call_projection_unnam0000jection2_projection0 thei_iord_bl_call_projection_unnamed_projection2_projection1 (
