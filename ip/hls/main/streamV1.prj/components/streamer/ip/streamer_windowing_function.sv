...
module streamer_windowing_function (
    ...
    input wire [63:0] in_arg_s_out_global,
    ...
    wire [0:0] bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoalmost_full;
    wire [0:0] bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoready;
    wire [0:0] bb_windowing_B1_start_out_iord_bl_s0_o_fifoalmost_full;
    wire [0:0] bb_windowing_B1_start_out_iord_bl_s0_o_fifoready;
    wire [447:0] bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifodata;
    wire [0:0] bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifovalid;
    ...
    wire [351:0] bb_windowing_B1_start_out_iowr_bl_s_out_o_fifodata;
    wire [0:0] bb_windowing_B1_start_out_iowr_bl_s_out_o_fifovalid;
    ...
    // bb_windowing_B1_start(BLACKBOX,3)
    streamer_bb_windowing_B1_start thebb_windowing_B1_start (
        ...
        .out_iord_bl_return_aggregation_o_fifoalmost_full(bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoalmost_full),
        .out_iord_bl_return_aggregation_o_fifoready(bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoready),
        .out_iord_bl_s0_o_fifoalmost_full(bb_windowing_B1_start_out_iord_bl_s0_o_fifoalmost_full),
        .out_iord_bl_s0_o_fifoready(bb_windowing_B1_start_out_iord_bl_s0_o_fifoready),
        .out_iowr_bl_call_aggregation_o_fifodata(bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifodata),
        .out_iowr_bl_call_aggregation_o_fifovalid(bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifovalid),
        ...
        .out_iowr_bl_s_out_o_fifodata(bb_windowing_B1_start_out_iowr_bl_s_out_o_fifodata),
        .out_iowr_bl_s_out_o_fifovalid(bb_windowing_B1_start_out_iowr_bl_s_out_o_fifovalid),
    ...
    // out_iord_bl_call_windowing_o_fifoalmost_full(GPOUT,30)
    assign out_iord_bl_call_windowing_o_fifoalmost_full = bb_windowing_B1_start_out_iord_bl_call_windowing_o_fifoalmost_full;

    // out_iord_bl_call_windowing_o_fifoready(GPOUT,31)
    assign out_iord_bl_call_windowing_o_fifoready = bb_windowing_B1_start_out_iord_bl_call_windowing_o_fifoready;

    // out_iord_bl_return_aggregation_o_fifoalmost_full(GPOUT,32)
    assign out_iord_bl_return_aggregation_o_fifoalmost_full = bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoalmost_full;

    // out_iord_bl_return_aggregation_o_fifoready(GPOUT,33)
    assign out_iord_bl_return_aggregation_o_fifoready = bb_windowing_B1_start_out_iord_bl_return_aggregation_o_fifoready;

    // out_iord_bl_s0_o_fifoalmost_full(GPOUT,34)
    assign out_iord_bl_s0_o_fifoalmost_full = bb_windowing_B1_start_out_iord_bl_s0_o_fifoalmost_full;

    // out_iord_bl_s0_o_fifoready(GPOUT,35)
    assign out_iord_bl_s0_o_fifoready = bb_windowing_B1_start_out_iord_bl_s0_o_fifoready;

    // out_iowr_bl_call_aggregation_o_fifodata(GPOUT,36)
    assign out_iowr_bl_call_aggregation_o_fifodata = bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifodata;

    // out_iowr_bl_call_aggregation_o_fifovalid(GPOUT,37)
    assign out_iowr_bl_call_aggregation_o_fifovalid = bb_windowing_B1_start_out_iowr_bl_call_aggregation_o_fifovalid;

    // out_iowr_bl_return_windowing_o_fifodata(GPOUT,38)
    assign out_iowr_bl_return_windowing_o_fifodata = bb_windowing_B1_start_out_iowr_bl_return_windowing_o_fifodata;

    // out_iowr_bl_return_windowing_o_fifovalid(GPOUT,39)
    assign out_iowr_bl_return_windowing_o_fifovalid = bb_windowing_B1_start_out_iowr_bl_return_windowing_o_fifovalid;

    // out_iowr_bl_s_out_o_fifodata(GPOUT,40)
    assign out_iowr_bl_s_out_o_fifodata = bb_windowing_B1_start_out_iowr_bl_s_out_o_fifodata;

    // out_iowr_bl_s_out_o_fifovalid(GPOUT,41)
    assign out_iowr_bl_s_out_o_fifovalid = bb_windowing_B1_start_out_iowr_bl_s_out_o_fifovalid;

    // bb_windowing_B0_runOnce(BLACKBOX,2)
    ...
    // windowing_B1_start_x(EXTIFACE,44)
