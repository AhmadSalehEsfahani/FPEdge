...
module projection_bb_B0_runOnce_stall_region (
    ...
    // out out_valid_out@1
    projection_B0_runOnce_merge_reg theprojection_B0_runOnce_merge_reg (
        .in_data_in(GND_q),
    ...
    // out out_stall_out@20000000
    // out out_valid_out@2
    projection_i_llvm_fpga_push_token_i1_wt_limpush_0 thei_llvm_fpga_push_token_i1_wt_limpush_projection1 (
        .in_data_in(GND_q),
    ...
    // out out_stall_out@20000000
    // out out_valid_out@2
    projection_i_llvm_fpga_pop_token_i1_wt_limpop_0 thei_llvm_fpga_pop_token_i1_wt_limpop_projection0 (
        .in_data_in(GND_q),
        .in_dir(GND_q),
