...
module projection_bb_B1_start (
    ...
    wire [0:0] bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoalmost_full;
    wire [0:0] bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoready;
    ...
    wire [351:0] bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifodata;
    wire [0:0] bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifovalid;
    ...
    projection_B1_start_merge theprojection_B1_start_merge (
    ...
    projection_B1_start_branch theprojection_B1_start_branch (
    ...
    projection_bb_B1_start_stall_region thebb_projection_B1_start_stall_region (
        ...
        .out_iord_bl_stream_in_tuple_o_fifoalmost_full(bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoalmost_full),
        .out_iord_bl_stream_in_tuple_o_fifoready(bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoready),
        ...
        .out_iowr_bl_stream_out_tuple_o_fifodata(bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifodata),
        .out_iowr_bl_stream_out_tuple_o_fifovalid(bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifovalid),
    ...
    // out_iord_bl_stream_in_tuple_o_fifoalmost_full(GPOUT,16)
    assign out_iord_bl_stream_in_tuple_o_fifoalmost_full = bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoalmost_full;

    // out_iord_bl_stream_in_tuple_o_fifoready(GPOUT,17)
    assign out_iord_bl_stream_in_tuple_o_fifoready = bb_projection_B1_start_stall_region_out_iord_bl_stream_in_tuple_o_fifoready;
    ...
    // out_iowr_bl_stream_out_tuple_o_fifodata(GPOUT,20)
    assign out_iowr_bl_stream_out_tuple_o_fifodata = bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifodata;

    // out_iowr_bl_stream_out_tuple_o_fifovalid(GPOUT,21)
    assign out_iowr_bl_stream_out_tuple_o_fifovalid = bb_projection_B1_start_stall_region_out_iowr_bl_stream_out_tuple_o_fifovalid;
