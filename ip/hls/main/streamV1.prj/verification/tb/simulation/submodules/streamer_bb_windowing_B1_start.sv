...
module streamer_bb_windowing_B1_start (
    ...
    wire [0:0] bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoalmost_full;
    wire [0:0] bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoready;
    ...
    wire [383:0] bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifodata;
    wire [0:0] bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifovalid;
    ...
    // windowing_B1_start_branch(BLACKBOX,32)
    ...
    // windowing_B1_start_merge(BLACKBOX,33)
    ...
    streamer_bb_windowing_B1_start_stall_region thebb_windowing_B1_start_stall_region (
        ...
        .out_iord_bl_s1_o_fifoalmost_full(bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoalmost_full),
        .out_iord_bl_s1_o_fifoready(bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoready),
        ...
        .out_iowr_bl_s2_o_fifodata(bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifodata),
        .out_iowr_bl_s2_o_fifovalid(bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifovalid),
    ...
    // out_iord_bl_call_windowing_o_fifoalmost_full(GPOUT,16)
    ...
    // out_iord_bl_call_windowing_o_fifoready(GPOUT,17)
    ...
    assign out_iord_bl_s1_o_fifoalmost_full = bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoalmost_full;

    // out_iord_bl_s1_o_fifoready(GPOUT,19)
    assign out_iord_bl_s1_o_fifoready = bb_windowing_B1_start_stall_region_out_iord_bl_s1_o_fifoready;

    // out_iowr_bl_return_windowing_o_fifodata(GPOUT,20)
    ...
    // out_iowr_bl_return_windowing_o_fifovalid(GPOUT,21)
    ...
    // out_iowr_bl_s2_o_fifodata(GPOUT,22)
    assign out_iowr_bl_s2_o_fifodata = bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifodata;

    // out_iowr_bl_s2_o_fifovalid(GPOUT,23)
    assign out_iowr_bl_s2_o_fifovalid = bb_windowing_B1_start_stall_region_out_iowr_bl_s2_o_fifovalid;
