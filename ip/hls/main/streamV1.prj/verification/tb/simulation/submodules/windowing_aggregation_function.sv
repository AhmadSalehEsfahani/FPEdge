...
module windowing_aggregation_function (
    ...
    windowing_i_llvm_fpga_pipeline_keep_goin0000regation2_valid_fifo thei_llvm_fpga_pipeline_keep_going_aggregation2_valid_fifo (
    ...
    windowing_i_llvm_fpga_pipeline_keep_going_aggregation2_sr thei_llvm_fpga_pipeline_keep_going_aggregation2_sr (
        .in_i_data(GND_q),
    ...
    windowing_bb_aggregation_B1_start thebb_aggregation_B1_start (
        .in_forked_0(GND_q),
    ...
    windowing_bb_aggregation_B0_runOnce thebb_aggregation_B0_runOnce (
    ...
    windowing_bb_aggregation_B1_start_sr_1 thebb_aggregation_B1_start_sr_1_aunroll_x (
