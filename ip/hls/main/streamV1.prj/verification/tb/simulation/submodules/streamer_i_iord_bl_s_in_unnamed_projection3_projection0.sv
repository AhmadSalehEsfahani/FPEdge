...
// SystemVerilog created from i_iord_bl_s_in_unnamed_projection3_projection0
...
module streamer_i_iord_bl_s_in_unnamed_projection3_projection0 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_s_in_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_s_in_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_s_in_i_fifodata),
    ...
    assign out_iord_bl_s_in_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,34)
    assign out_iord_bl_s_in_o_fifoalmost_full = iord_o_fifoalmost_full;
