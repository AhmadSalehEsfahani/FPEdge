...
module streamer_bb_B1_start (
    ...
    wire [0:0] bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifodata;
    wire [0:0] bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifovalid;
    ...
    // streamer_B1_start_merge(BLACKBOX,38)
    ...
    // streamer_B1_start_branch(BLACKBOX,37)
    ...
    streamer_bb_B1_start_stall_region thebb_streamer_B1_start_stall_region (
        ...
        .out_iowr_bl_return_streamer_o_fifodata(bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifodata),
        .out_iowr_bl_return_streamer_o_fifovalid(bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifovalid),
    ...
    // out_iord_bl_call_streamer_o_fifoalmost_full(GPOUT,17)
    ...
    // out_iord_bl_return_projection_o_fifoready(GPOUT,20)
    ...
    // out_iord_bl_return_windowing_o_fifoalmost_full(GPOUT,21)
    ...
    // out_iord_bl_return_windowing_o_fifoready(GPOUT,22)
    ...
    // out_iowr_bl_call_projection_o_fifodata(GPOUT,23)
    assign out_iowr_bl_call_projection_o_fifodata = bb_streamer_B1_start_stall_region_out_iowr_bl_call_projection_o_fifodata;

    // out_iowr_bl_call_projection_o_fifovalid(GPOUT,24)
    assign out_iowr_bl_call_projection_o_fifovalid = bb_streamer_B1_start_stall_region_out_iowr_bl_call_projection_o_fifovalid;

    // out_iowr_bl_call_windowing_o_fifodata(GPOUT,25)
    assign out_iowr_bl_call_windowing_o_fifodata = bb_streamer_B1_start_stall_region_out_iowr_bl_call_windowing_o_fifodata;

    // out_iowr_bl_call_windowing_o_fifovalid(GPOUT,26)
    assign out_iowr_bl_call_windowing_o_fifovalid = bb_streamer_B1_start_stall_region_out_iowr_bl_call_windowing_o_fifovalid;

    // out_iowr_bl_return_streamer_o_fifodata(GPOUT,27)
    assign out_iowr_bl_return_streamer_o_fifodata = bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifodata;

    // out_iowr_bl_return_streamer_o_fifovalid(GPOUT,28)
    assign out_iowr_bl_return_streamer_o_fifovalid = bb_streamer_B1_start_stall_region_out_iowr_bl_return_streamer_o_fifovalid;
