...
module projection_i_sfc_logic_s_c0_in_wt_entry_s_c0_enter1_projection0 (
    ...
    projection_i_llvm_fpga_pipeline_keep_going_0 thei_llvm_fpga_pipeline_keep_going_projection1 (
        .in_data_in(VCC_q),
    ...
    projection_i_llvm_fpga_push_i1_notexitcond_0 thei_llvm_fpga_push_i1_notexitcond_projection2 (
        .in_data_in(VCC_q),
