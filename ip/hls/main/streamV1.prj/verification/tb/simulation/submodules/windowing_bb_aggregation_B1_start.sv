...
module windowing_bb_aggregation_B1_start (
    ...
    windowing_aggregation_B1_start_branch theaggregation_B1_start_branch (
    ...
    windowing_aggregation_B1_start_merge theaggregation_B1_start_merge (
    ...
    windowing_bb_aggregation_B1_start_stall_region thebb_aggregation_B1_start_stall_region (
