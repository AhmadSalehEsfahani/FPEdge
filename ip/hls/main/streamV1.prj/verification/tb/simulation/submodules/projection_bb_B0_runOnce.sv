...
module projection_bb_B0_runOnce (
    ...
    projection_B0_runOnce_branch theprojection_B0_runOnce_branch (
    ...
    projection_bb_B0_runOnce_stall_region thebb_projection_B0_runOnce_stall_region (
    ...
    projection_B0_runOnce_merge theprojection_B0_runOnce_merge (
