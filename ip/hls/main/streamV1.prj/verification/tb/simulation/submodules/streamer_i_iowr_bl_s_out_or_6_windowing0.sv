...
// SystemVerilog created from i_iowr_bl_s_out_or_6_windowing0
...
module streamer_i_iowr_bl_s_out_or_6_windowing0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_s_out_i_fifoready;
    ...
    assign out_iowr_bl_s_out_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_s_out_o_fifodata = iowr_o_fifodata;
