...
// SystemVerilog created from i_iowr_bl_call_aggregation_unnamed_windowing3_windowing0
...
module windowing_i_iowr_bl_call_aggregation_unnamed_3_windowing0 (
    output wire [0:0] out_iowr_bl_call_aggregation_o_fifovalid,
    output wire [0:0] out_o_ack,
    output wire [0:0] out_o_valid,
    input wire [0:0] in_c0_exe4140,
    ...
    wire [351:0] dsdk_ip_adapt_bitjoin3_q;
    wire [159:0] dsdk_ip_array_adapt_bitjoin10_q;
    wire [127:0] dsdk_ip_array_adapt_bitjoin6_q;
    wire [7:0] element_extension24_q;
    wire [447:0] iowr_i_data;
    ...
    // c_i24_026(CONSTANT,20)
    assign c_i24_026_q = $unsigned(24'b000000000000000000000000);

    // c_i7_025(CONSTANT,23)
    assign c_i7_025_q = $unsigned(7'b0000000);

    // element_extension24(BITJOIN,29)
    assign element_extension24_q = {c_i7_025_q, in_i_data_13_tpl};

    // dsdk_ip_array_adapt_bitjoin10(BITJOIN,27)
    assign dsdk_ip_array_adapt_bitjoin10_q = {in_i_data_10_tpl, in_i_data_9_tpl, in_i_data_8_tpl, in_i_data_7_tpl, in_i_data_6_tpl};

    // dsdk_ip_array_adapt_bitjoin6(BITJOIN,28)
    assign dsdk_ip_array_adapt_bitjoin6_q = {in_i_data_4_tpl, in_i_data_3_tpl, in_i_data_2_tpl, in_i_data_1_tpl};

    // dsdk_ip_adapt_bitjoin3(BITJOIN,26)
    assign dsdk_ip_adapt_bitjoin3_q = {dsdk_ip_array_adapt_bitjoin10_q, c_i24_026_q, in_i_data_5_tpl, dsdk_ip_array_adapt_bitjoin6_q, c_i24_026_q, in_i_data_0_tpl};

    // dsdk_ip_adapt_bitjoin1(BITJOIN,25)
    assign dsdk_ip_adapt_bitjoin1_q = {c_i24_026_q, element_extension24_q, in_i_data_12_tpl, in_i_data_11_tpl, dsdk_ip_adapt_bitjoin3_q};

    // iowr(EXTIFACE,30)
    assign iowr_i_data = dsdk_ip_adapt_bitjoin1_q;
    assign iowr_i_endofpacket = GND_q;
    assign iowr_i_fifoready = in_iowr_bl_call_aggregation_i_fifoready;
    assign iowr_i_fifosize = dupName_0_const_0_x_q;
    assign iowr_i_packetempty = dupName_0_const_0_x_q;
    assign iowr_i_predicate = in_c0_exe4140;
    ...
    assign out_iowr_bl_call_aggregation_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_call_aggregation_o_fifodata = iowr_o_fifodata;
