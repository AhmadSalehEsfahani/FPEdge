...
module projection_function (
    ...
    wire [0:0] bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoalmost_full;
    wire [0:0] bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoready;
    ...
    wire [351:0] bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifodata;
    wire [0:0] bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifovalid;
    ...
    projection_i_llvm_fpga_pipeline_keep_going_1_valid_fifo thei_llvm_fpga_pipeline_keep_going_projection1_valid_fifo (
    ...
    projection_i_llvm_fpga_pipeline_keep_going_1_sr thei_llvm_fpga_pipeline_keep_going_projection1_sr (
        .in_i_data(GND_q),
    ...
    projection_bb_B1_start thebb_projection_B1_start (
        ...
        .out_iord_bl_stream_in_tuple_o_fifoalmost_full(bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoalmost_full),
        .out_iord_bl_stream_in_tuple_o_fifoready(bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoready),
        ...
        .out_iowr_bl_stream_out_tuple_o_fifodata(bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifodata),
        .out_iowr_bl_stream_out_tuple_o_fifovalid(bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifovalid),
    ...
    // out_iord_bl_stream_in_tuple_o_fifoalmost_full(GPOUT,27)
    assign out_iord_bl_stream_in_tuple_o_fifoalmost_full = bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoalmost_full;

    // out_iord_bl_stream_in_tuple_o_fifoready(GPOUT,28)
    assign out_iord_bl_stream_in_tuple_o_fifoready = bb_projection_B1_start_out_iord_bl_stream_in_tuple_o_fifoready;
    ...
    // out_iowr_bl_stream_out_tuple_o_fifodata(GPOUT,31)
    assign out_iowr_bl_stream_out_tuple_o_fifodata = bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifodata;

    // out_iowr_bl_stream_out_tuple_o_fifovalid(GPOUT,32)
    assign out_iowr_bl_stream_out_tuple_o_fifovalid = bb_projection_B1_start_out_iowr_bl_stream_out_tuple_o_fifovalid;

    // bb_projection_B0_runOnce(BLACKBOX,2)
    projection_bb_B0_runOnce thebb_projection_B0_runOnce (
        .in_stall_in_0(GND_q),
