...
// SystemVerilog created from i_iord_bl_stream_in_tuple_unnamed_windowing2_windowing0
...
module windowing_i_iord_bl_stream_in_tuple_unnamed_2_windowing0 (
    ...
    wire [159:0] ip_dsdk_adapt_bitselect16_b;
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_stream_in_tuple_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_stream_in_tuple_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_stream_in_tuple_i_fifodata),
    ...
    assign ip_dsdk_adapt_bitselect16_b = iord_o_data[351:192];

    // ip_dsdk_adapt_bitselect26(BITSELECT,17)
    assign ip_dsdk_adapt_bitselect26_b = ip_dsdk_adapt_bitselect16_b[159:128];
    ...
    assign ip_dsdk_adapt_bitselect14_b = iord_o_data[167:160];

    // ip_dsdk_adapt_bitselect4(BITSELECT,18)
    ...
    // ip_dsdk_adapt_bitselect8(BITSELECT,20)
    assign ip_dsdk_adapt_bitselect8_b = ip_dsdk_adapt_bitselect4_b[63:32];

    // ip_dsdk_adapt_bitselect6(BITSELECT,19)
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,2)@0
    ...
    assign out_iord_bl_stream_in_tuple_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,34)
    assign out_iord_bl_stream_in_tuple_o_fifoalmost_full = iord_o_fifoalmost_full;
