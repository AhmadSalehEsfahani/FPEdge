...
//   output_name:       tb_projection_component_dpi_controller_stream_active_concatenate_inst
//   multibit_width:    1
//
// ------------------------------------------

module tb_projection_component_dpi_controller_stream_active_concatenate_inst
#(
