...
target triple = "x86_64-pc-windows-msvc19.16.27048"

%"class.ihc::stream" = type { i8 }
%"class.ihc::stream_checker" = type { i8 }
%struct.Tuple = type { i32, i32, i32 }

$"?read@?$stream@UTuple@@$$V@ihc@@QEAA?AUTuple@@_N@Z" = comdat any
...
entry:
  ...
  call void @"?read@?$stream@UTuple@@$$V@ihc@@QEAA?AUTuple@@_N@Z"(%"class.ihc::stream"* @"?s0@@3V?$stream@UTuple@@$$V@ihc@@A", %struct.Tuple* sret align 4 %tuple, i1 zeroext true), !dbg !1269
  %a = getelementptr inbounds %struct.Tuple, %struct.Tuple* %tuple, i32 0, i32 0, !dbg !1270
  %1 = load i32, i32* %a, align 4, !dbg !1270, !tbaa !1271
  %b = getelementptr inbounds %struct.Tuple, %struct.Tuple* %tuple, i32 0, i32 1, !dbg !1276
  %2 = load i32, i32* %b, align 4, !dbg !1276, !tbaa !1277
  %add = add nsw i32 %1, %2, !dbg !1278
  ...
  %3 = bitcast %struct.Tuple* %tuple to i8*, !dbg !1283
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %3) #7, !dbg !1283
  ret void, !dbg !1283
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @"?read@?$stream@UTuple@@$$V@ihc@@QEAA?AUTuple@@_N@Z"(%"class.ihc::stream"* %this, %struct.Tuple* noalias sret align 4 %agg.result, i1 zeroext %wait) #0 comdat align 2 !dbg !1284 {
entry:
  ...
  %0 = bitcast %struct.Tuple* %agg.result to i8*
  store i8* %0, i8** %result.ptr, align 8
  %frombool = zext i1 %wait to i8
  store i8 %frombool, i8* %wait.addr, align 1, !tbaa !1292
  call void @llvm.dbg.declare(metadata i8* %wait.addr, metadata !1286, metadata !DIExpression()), !dbg !1294
  store %"class.ihc::stream"* %this, %"class.ihc::stream"** %this.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %"class.ihc::stream"** %this.addr, metadata !1287, metadata !DIExpression()), !dbg !1297
  %this1 = load %"class.ihc::stream"*, %"class.ihc::stream"** %this.addr, align 8
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %sop) #7, !dbg !1298
  call void @llvm.dbg.declare(metadata i8* %sop, metadata !1289, metadata !DIExpression()), !dbg !1299
  store i8 0, i8* %sop, align 1, !dbg !1299, !tbaa !1292
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %eop) #7, !dbg !1300
  call void @llvm.dbg.declare(metadata i8* %eop, metadata !1290, metadata !DIExpression()), !dbg !1301
  store i8 0, i8* %eop, align 1, !dbg !1301, !tbaa !1292
  %1 = bitcast i32* %emp to i8*, !dbg !1302
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #7, !dbg !1302
  call void @llvm.dbg.declare(metadata i32* %emp, metadata !1291, metadata !DIExpression()), !dbg !1303
  store i32 0, i32* %emp, align 4, !dbg !1303, !tbaa !1304
  %2 = ptrtoint %"class.ihc::stream"* %this1 to i64, !dbg !1305
  %3 = call { %struct.Tuple*, i8, i8, i32 } @llvm.intel.hls.instream.read.s_struct.Tuples(i64 %2, i32 0, i32 0, i32 0, i1 false, i1 false, i1 false, i1 true), !dbg !1306
  %4 = extractvalue { %struct.Tuple*, i8, i8, i32 } %3, 1, !dbg !1306
  store i8 %4, i8* %sop, align 1, !dbg !1306
  %5 = extractvalue { %struct.Tuple*, i8, i8, i32 } %3, 2, !dbg !1306
  store i8 %5, i8* %eop, align 1, !dbg !1306
  %6 = extractvalue { %struct.Tuple*, i8, i8, i32 } %3, 3, !dbg !1306
  store i32 %6, i32* %emp, align 4, !dbg !1306
  %7 = extractvalue { %struct.Tuple*, i8, i8, i32 } %3, 0, !dbg !1306
  %8 = bitcast %struct.Tuple* %agg.result to i8*, !dbg !1307
  %9 = bitcast %struct.Tuple* %7 to i8*, !dbg !1307
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %8, i8* align 4 %9, i64 12, i1 false), !dbg !1307, !tbaa.struct !1308
  %10 = bitcast i32* %emp to i8*, !dbg !1309
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %10) #7, !dbg !1309
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %eop) #7, !dbg !1309
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %sop) #7, !dbg !1309
  ret void, !dbg !1309
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @"?write@?$stream@UTuple@@$$V@ihc@@QEAAXAEBUTuple@@@Z"(%"class.ihc::stream"* %this, %struct.Tuple* nonnull align 4 dereferenceable(12) %arg) #0 comdat align 2 !dbg !1310 {
entry:
  %arg.addr = alloca %struct.Tuple*, align 8
  %this.addr = alloca %"class.ihc::stream"*, align 8
  store %struct.Tuple* %arg, %struct.Tuple** %arg.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %struct.Tuple** %arg.addr, metadata !1312, metadata !DIExpression()), !dbg !1314
  store %"class.ihc::stream"* %this, %"class.ihc::stream"** %this.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %"class.ihc::stream"** %this.addr, metadata !1313, metadata !DIExpression()), !dbg !1315
  %this1 = load %"class.ihc::stream"*, %"class.ihc::stream"** %this.addr, align 8
  call void @"?checkIfUsesEmptyThenUsesPackets@?$stream_checker@UTuple@@$0A@$0A@$0A@$0A@$0A@$0A@$00$00@ihc@@QEBAXXZ"(%"class.ihc::stream_checker"* @"?checker@?$stream@UTuple@@$$V@ihc@@0V?$stream_checker@UTuple@@$0A@$0A@$0A@$0A@$0A@$0A@$00$00@2@B"), !dbg !1316
  %0 = load %struct.Tuple*, %struct.Tuple** %arg.addr, align 8, !dbg !1317, !tbaa !1295
  %1 = ptrtoint %"class.ihc::stream"* %this1 to i64, !dbg !1318
  call void @llvm.intel.hls.outstream.write.s_struct.Tuples(%struct.Tuple* %0, i64 %1, i32 0, i32 0, i32 0, i1 false, i1 false, i1 false, i1 true, i1 false, i1 false, i32 0), !dbg !1319
  ret void, !dbg !1320
}
...
define dso_local void @"?streamer@@YA?AUTuple@@AEAU1@@Z"(%struct.Tuple* noalias sret align 4 %agg.result, %struct.Tuple* nonnull align 4 dereferenceable(12) %tuple) #4 !dbg !1321 !ihc_component !1327 !arg_type !1328 !impl_type !1329 !stable !1330 !cosim_name !1331 !memory !1332 !component_interface !1329 !stall_free_return !1333 !use_single_clock !1330 {
entry:
  %result.ptr = alloca i8*, align 8
  ...
  %0 = bitcast %struct.Tuple* %agg.result to i8*
  store i8* %0, i8** %result.ptr, align 8
  store %struct.Tuple* %tuple, %struct.Tuple** %tuple.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %struct.Tuple** %tuple.addr, metadata !1326, metadata !DIExpression()), !dbg !1334
  %1 = load %struct.Tuple*, %struct.Tuple** %tuple.addr, align 8, !dbg !1335, !tbaa !1295
  call void @"?write@?$stream@UTuple@@$$V@ihc@@QEAAXAEBUTuple@@@Z"(%"class.ihc::stream"* @"?s0@@3V?$stream@UTuple@@$$V@ihc@@A", %struct.Tuple* nonnull align 4 dereferenceable(12) %1), !dbg !1336
  call void @"?adder@@YAXXZ"(), !dbg !1337
  %2 = bitcast %struct.Tuple* %ref.tmp to i8*, !dbg !1338
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %2) #7, !dbg !1338
  call void @"?read@?$stream@UTuple@@$$V@ihc@@QEAA?AUTuple@@_N@Z"(%"class.ihc::stream"* @"?s1@@3V?$stream@UTuple@@$$V@ihc@@A", %struct.Tuple* sret align 4 %ref.tmp, i1 zeroext true), !dbg !1339
  %3 = load %struct.Tuple*, %struct.Tuple** %tuple.addr, align 8, !dbg !1340, !tbaa !1295
  %4 = bitcast %struct.Tuple* %3 to i8*, !dbg !1341
  %5 = bitcast %struct.Tuple* %ref.tmp to i8*, !dbg !1341
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %4, i8* align 4 %5, i64 12, i1 false), !dbg !1341, !tbaa.struct !1308
  %6 = bitcast %struct.Tuple* %ref.tmp to i8*, !dbg !1340
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %6) #7, !dbg !1340
  %7 = load %struct.Tuple*, %struct.Tuple** %tuple.addr, align 8, !dbg !1342, !tbaa !1295
  %8 = bitcast %struct.Tuple* %agg.result to i8*, !dbg !1342
  %9 = bitcast %struct.Tuple* %7 to i8*, !dbg !1342
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %8, i8* align 4 %9, i64 12, i1 false), !dbg !1342, !tbaa.struct !1308
  ret void, !dbg !1343
}
...
define dso_local i32 @main() #5 !dbg !1344 {
entry:
  %retval = alloca i32, align 4
  %tuple = alloca %struct.Tuple, align 4
  %res = alloca %struct.Tuple, align 4
  store i32 0, i32* %retval, align 4
  %0 = bitcast %struct.Tuple* %tuple to i8*, !dbg !1348
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %0) #7, !dbg !1348
  call void @llvm.dbg.declare(metadata %struct.Tuple* %tuple, metadata !1346, metadata !DIExpression()), !dbg !1349
  %call = call %struct.Tuple* @"??0Tuple@@QEAA@XZ"(%struct.Tuple* %tuple) #7, !dbg !1349
  %a = getelementptr inbounds %struct.Tuple, %struct.Tuple* %tuple, i32 0, i32 0, !dbg !1350
  store i32 5, i32* %a, align 4, !dbg !1351, !tbaa !1271
  %b = getelementptr inbounds %struct.Tuple, %struct.Tuple* %tuple, i32 0, i32 1, !dbg !1352
  store i32 6, i32* %b, align 4, !dbg !1353, !tbaa !1277
  %1 = bitcast %struct.Tuple* %res to i8*, !dbg !1354
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %1) #7, !dbg !1354
  call void @llvm.dbg.declare(metadata %struct.Tuple* %res, metadata !1347, metadata !DIExpression()), !dbg !1355
  call void @"?streamer@@YA?AUTuple@@AEAU1@@Z"(%struct.Tuple* sret align 4 %res, %struct.Tuple* nonnull align 4 dereferenceable(12) %tuple), !dbg !1356
  %2 = bitcast %struct.Tuple* %res to i8*, !dbg !1357
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %2) #7, !dbg !1357
  %3 = bitcast %struct.Tuple* %tuple to i8*, !dbg !1357
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %3) #7, !dbg !1357
  ret i32 0, !dbg !1358
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local %struct.Tuple* @"??0Tuple@@QEAA@XZ"(%struct.Tuple* returned %this) unnamed_addr #6 comdat align 2 !dbg !1359 {
entry:
  %this.addr = alloca %struct.Tuple*, align 8
  store %struct.Tuple* %this, %struct.Tuple** %this.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %struct.Tuple** %this.addr, metadata !1365, metadata !DIExpression()), !dbg !1367
  %this1 = load %struct.Tuple*, %struct.Tuple** %this.addr, align 8
  %a = getelementptr inbounds %struct.Tuple, %struct.Tuple* %this1, i32 0, i32 0, !dbg !1368
  store i32 0, i32* %a, align 4, !dbg !1368, !tbaa !1271
  %b = getelementptr inbounds %struct.Tuple, %struct.Tuple* %this1, i32 0, i32 1, !dbg !1369
  store i32 0, i32* %b, align 4, !dbg !1369, !tbaa !1277
  %res = getelementptr inbounds %struct.Tuple, %struct.Tuple* %this1, i32 0, i32 2, !dbg !1370
  store i32 0, i32* %res, align 4, !dbg !1370, !tbaa !1281
  ret %struct.Tuple* %this1, !dbg !1371
}

declare { %struct.Tuple*, i8, i8, i32 } @llvm.intel.hls.instream.read.s_struct.Tuples(i64, i32, i32, i32, i1, i1, i1, i1)

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @"?checkIfUsesEmptyThenUsesPackets@?$stream_checker@UTuple@@$0A@$0A@$0A@$0A@$0A@$0A@$00$00@ihc@@QEBAXXZ"(%"class.ihc::stream_checker"* %this) #0 comdat align 2 !dbg !1372 {
entry:
  %this.addr = alloca %"class.ihc::stream_checker"*, align 8
  store %"class.ihc::stream_checker"* %this, %"class.ihc::stream_checker"** %this.addr, align 8, !tbaa !1295
  call void @llvm.dbg.declare(metadata %"class.ihc::stream_checker"** %this.addr, metadata !1374, metadata !DIExpression()), !dbg !1376
...
; Function Attrs: nounwind uwtable
define internal void @_GLOBAL__sub_I_main.cpp() #0 !dbg !1378 {
entry:
  call void @"??__Es0@@YAXXZ"(), !dbg !1380
  call void @"??__Es1@@YAXXZ"(), !dbg !1380
  call void @"??__Es2@@YAXXZ"(), !dbg !1380
  ret void
}
...
!216 = !DICompositeType(tag: DW_TAG_structure_type, name: "_div_t", file: !215, line: 271, flags: DIFlagFwdDecl, identifier: ".?AU_div_t@@")
...
!403 = !DICompositeType(tag: DW_TAG_structure_type, name: "_iobuf", file: !402, line: 25, flags: DIFlagFwdDecl, identifier: ".?AU_iobuf@@")
...
!659 = !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !660, line: 22, flags: DIFlagFwdDecl, identifier: ".?AUtm@@")
...
!1244 = !DICompositeType(tag: DW_TAG_class_type, name: "type_info", file: !1245, line: 65, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: ".?AVtype_info@@")
...
!1284 = distinct !DISubprogram(name: "read", linkageName: "?read@?$stream@UTuple@@$$V@ihc@@QEAA?AUTuple@@_N@Z", scope: !7, file: !8, line: 840, type: !136, scopeLine: 840, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !135, retainedNodes: !1285)
!1285 = !{!1286, !1287, !1289, !1290, !1291}
!1286 = !DILocalVariable(name: "wait", arg: 2, scope: !1284, file: !8, line: 213, type: !32)
...
!1289 = !DILocalVariable(name: "sop", scope: !1284, file: !8, line: 842, type: !32)
!1290 = !DILocalVariable(name: "eop", scope: !1284, file: !8, line: 843, type: !32)
!1291 = !DILocalVariable(name: "emp", scope: !1284, file: !8, line: 844, type: !39)
!1292 = !{!1293, !1293, i64 0}
!1293 = !{!"bool", !1274, i64 0}
!1294 = !DILocation(line: 213, column: 16, scope: !1284)
!1295 = !{!1296, !1296, i64 0}
!1296 = !{!"any pointer", !1274, i64 0}
!1297 = !DILocation(line: 0, scope: !1284)
!1298 = !DILocation(line: 842, column: 3, scope: !1284)
!1299 = !DILocation(line: 842, column: 8, scope: !1284)
!1300 = !DILocation(line: 843, column: 3, scope: !1284)
!1301 = !DILocation(line: 843, column: 8, scope: !1284)
!1302 = !DILocation(line: 844, column: 3, scope: !1284)
!1303 = !DILocation(line: 844, column: 7, scope: !1284)
!1304 = !{!1273, !1273, i64 0}
!1305 = !DILocation(line: 846, column: 16, scope: !1284)
!1306 = !DILocation(line: 845, column: 11, scope: !1284)
!1307 = !DILocation(line: 845, column: 10, scope: !1284)
!1308 = !{i64 0, i64 4, !1304, i64 4, i64 4, !1304, i64 8, i64 4, !1304}
!1309 = !DILocation(line: 849, column: 1, scope: !1284)
!1310 = distinct !DISubprogram(name: "write", linkageName: "?write@?$stream@UTuple@@$$V@ihc@@QEAAXAEBUTuple@@@Z", scope: !7, file: !8, line: 851, type: !139, scopeLine: 851, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !138, retainedNodes: !1311)
!1311 = !{!1312, !1313}
!1312 = !DILocalVariable(name: "arg", arg: 2, scope: !1310, file: !8, line: 214, type: !45)
!1313 = !DILocalVariable(name: "this", arg: 1, scope: !1310, type: !1288, flags: DIFlagArtificial | DIFlagObjectPointer)
!1314 = !DILocation(line: 214, column: 24, scope: !1310)
!1315 = !DILocation(line: 0, scope: !1310)
!1316 = !DILocation(line: 852, column: 11, scope: !1310)
!1317 = !DILocation(line: 853, column: 40, scope: !1310)
!1318 = !DILocation(line: 853, column: 45, scope: !1310)
!1319 = !DILocation(line: 853, column: 3, scope: !1310)
!1320 = !DILocation(line: 857, column: 1, scope: !1310)
!1321 = distinct !DISubprogram(name: "streamer", linkageName: "?streamer@@YA?AUTuple@@AEAU1@@Z", scope: !3, file: !3, line: 202, type: !1322, scopeLine: 202, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !1325)
!1322 = !DISubroutineType(types: !1323)
!1323 = !{!36, !1324}
!1324 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !36, size: 64)
!1325 = !{!1326}
!1326 = !DILocalVariable(name: "tuple", arg: 1, scope: !1321, file: !3, line: 202, type: !1324)
!1327 = !{!"?streamer@@YA?AUTuple@@AEAU1@@Z", !4}
!1328 = !{!"pointer"}
!1329 = !{!"avalon_mm_agent"}
!1330 = !{i32 0}
!1331 = !{!"tuple"}
!1332 = !{!""}
!1333 = !{i32 1}
!1334 = !DILocation(line: 202, column: 69, scope: !1321)
!1335 = !DILocation(line: 205, column: 14, scope: !1321)
!1336 = !DILocation(line: 205, column: 8, scope: !1321)
!1337 = !DILocation(line: 207, column: 5, scope: !1321)
!1338 = !DILocation(line: 209, column: 13, scope: !1321)
!1339 = !DILocation(line: 209, column: 16, scope: !1321)
!1340 = !DILocation(line: 209, column: 5, scope: !1321)
!1341 = !DILocation(line: 209, column: 11, scope: !1321)
!1342 = !DILocation(line: 212, column: 12, scope: !1321)
!1343 = !DILocation(line: 212, column: 5, scope: !1321)
!1344 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 216, type: !321, scopeLine: 216, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !1345)
!1345 = !{!1346, !1347}
!1346 = !DILocalVariable(name: "tuple", scope: !1344, file: !3, line: 218, type: !36)
!1347 = !DILocalVariable(name: "res", scope: !1344, file: !3, line: 222, type: !36)
!1348 = !DILocation(line: 218, column: 5, scope: !1344)
!1349 = !DILocation(line: 218, column: 11, scope: !1344)
!1350 = !DILocation(line: 219, column: 11, scope: !1344)
!1351 = !DILocation(line: 219, column: 13, scope: !1344)
!1352 = !DILocation(line: 220, column: 11, scope: !1344)
!1353 = !DILocation(line: 220, column: 13, scope: !1344)
!1354 = !DILocation(line: 222, column: 5, scope: !1344)
!1355 = !DILocation(line: 222, column: 11, scope: !1344)
!1356 = !DILocation(line: 222, column: 17, scope: !1344)
!1357 = !DILocation(line: 229, column: 1, scope: !1344)
!1358 = !DILocation(line: 227, column: 5, scope: !1344)
!1359 = distinct !DISubprogram(name: "Tuple", linkageName: "??0Tuple@@QEAA@XZ", scope: !36, file: !3, line: 31, type: !1360, scopeLine: 31, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !1363, retainedNodes: !1364)
!1360 = !DISubroutineType(types: !1361)
!1361 = !{null, !1362}
!1362 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !36, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1363 = !DISubprogram(name: "Tuple", scope: !36, type: !1360, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1364 = !{!1365}
!1365 = !DILocalVariable(name: "this", arg: 1, scope: !1359, type: !1366, flags: DIFlagArtificial | DIFlagObjectPointer)
!1366 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !36, size: 64)
!1367 = !DILocation(line: 0, scope: !1359)
!1368 = !DILocation(line: 32, column: 9, scope: !1359)
!1369 = !DILocation(line: 33, column: 9, scope: !1359)
!1370 = !DILocation(line: 34, column: 9, scope: !1359)
!1371 = !DILocation(line: 31, column: 8, scope: !1359)
!1372 = distinct !DISubprogram(name: "checkIfUsesEmptyThenUsesPackets", linkageName: "?checkIfUsesEmptyThenUsesPackets@?$stream_checker@UTuple@@$0A@$0A@$0A@$0A@$0A@$0A@$00$00@ihc@@QEBAXXZ", scope: !97, file: !8, line: 98, type: !100, scopeLine: 98, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !104, retainedNodes: !1373)
!1373 = !{!1374}
!1374 = !DILocalVariable(name: "this", arg: 1, scope: !1372, type: !1375, flags: DIFlagArtificial | DIFlagObjectPointer)
!1375 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !96, size: 64)
!1376 = !DILocation(line: 0, scope: !1372)
!1377 = !DILocation(line: 103, column: 3, scope: !1372)
!1378 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_main.cpp", scope: !3, file: !3, type: !1379, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
!1379 = !DISubroutineType(types: !4)
